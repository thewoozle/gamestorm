	...
	<template>
		<div id="convention_select" class="convention_select">
			...
			<div class="buttons">
				<button class="button" @click="(() => {showConInfo = true; update_currentCon({active: 1})})" >New Convention</button>
				...
				<div class="section_content">
					<form class="con_form" @submit.prevent="update_convention" >
						...
						<div class="form_row con_tag_row" :class="currentCon.short_name? 'show' : ''">
							...
							<div class="input_wrapper">
								<input type="text" disabled class="text_box" :value="create_tag_name()" title="autogenerated from short-name unless previously set" />
							</div>
						</div>	
         ...
         watch: {
            ...
            create_tag_name() {
               var   vm = this,
                     tagName;
                  if(vm.currentCon.tag_name) {
                     tagName = vm.currentCon.tag_name;   
                  } else {                  
                     vm.currentCon.short_name? tagName = vm.currentCon.short_name.replace(/ /gi, '_').toLowerCase() : tagName = '';
                  }
               return tagName;
            },
